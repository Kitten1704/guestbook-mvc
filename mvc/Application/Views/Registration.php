<html>
	...
	<body>
		<div class="container">
			<div class="title">
			<div class="title_links"><a href="Login">Войти</a>&nbsp;|&nbsp;<a href="Home">На главную</a></div>
			</div>
		...
		*_error - текст предупреждений, если не все поля заполнены-->
		...
		<h3>Регистрация</h3>
		<p>Имя: * <input class="text_color" type="text" name="name" value="<?php if (isset($_SESSION['name'])) echo $_SESSION['name'];?>">&nbsp;
		Фамилия:<input class="text_color" type="text" name="sname" size="24" value="<?php if (isset($_SESSION['sname'])) echo $_SESSION['sname'];?>"></p>
		<h4><?php if (isset($_SESSION['er_name'])) echo $_SESSION['er_name'];?></h4>	
		<p>E-mail:*<input class="text_color" type="text" name="email" size="63" value="<?php if (isset($_SESSION['email'])) echo $_SESSION['email'];?>"></p>
		...
		<p>Пароль:*<input class="text_color" type="password" name="password" size="61" value=""></p>
		<h4><?php if (isset($_SESSION['er_password'])) echo $_SESSION['er_password'];?></h4>
		<p>Подтвердите пароль:*<input class="text_color" type="password" name="re_password" size="44" value=""></p>
